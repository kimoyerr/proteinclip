# From: https://github.com/BobMcDear/attorch/blob/main/attorch/layer_norm_kernels.py
...
from proteinclip.triton_utils import next_power_of_2, warps_kernel_configs, BLOCK_SIZE_BATCH_heuristic
